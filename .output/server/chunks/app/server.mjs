import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, createVNode, mergeProps, Transition, toRefs, shallowRef, ref, computed, watch, nextTick, toRef, watchEffect, provide, onScopeDispose, withDirectives, vShow, Fragment, resolveDirective, reactive, onUnmounted, createTextVNode, capitalize, h, defineComponent as defineComponent$1, shallowReactive, Suspense, camelize, toRaw, readonly, TransitionGroup, isRef, Text, resolveDynamicComponent, effectScope, warn, Teleport, cloneVNode, withModifiers, toDisplayString, vModelText, useSSRContext, createApp, isVNode, Comment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, resolveComponent, withCtx } from 'vue';
import { h as useRuntimeConfig$1, $ as $fetch, w as withQuery, m as hasProtocol, p as parseURL, n as isScriptProtocol, j as joinURL, i as createError$1, o as defu, q as sanitizeStatusCode, t as createHooks } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ffd76950.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-9ad3b480.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-6dcad564.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-b286c0c1.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useRuntimeConfig as a, navigateTo as b, createError as c, asyncDataDefaults as d, entry$1 as default, useNuxtApp as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter$1 as u };
